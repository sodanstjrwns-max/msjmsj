...
export const renderer = jsxRenderer(({ children }, c) => (
  <html lang="ko">
    <head>
      ...
      <meta name="description" content="저도 치과가 무서웠습니다. 어린 시절의 경험에서 시작된 치과의사 문석준의 진료 이야기. 환자분의 작은 용기를 소중히 생각하는 마음과 글, 책, 영상을 나눕니다." />
      ...
      <meta property="og:description" content="저도 치과가 무서웠습니다. 어렵게 내신 용기를 소중히 생각하며, 환자분의 이야기부터 충분히 듣고 싶습니다." />
      ...
      <link rel="stylesheet" href="/static/style.css?v=story-expanded-20260925" />
      <script src="/static/app.js?v=story-expanded-20260925" defer></script>
    </head>
    <body>{children}</body>
  </html>
))
