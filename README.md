...
공개 전 본인 얼굴·동작·문안·생성 인사 사용 범위, 대표 콘텐츠 및 저술 노출을 검토한다. 의료 자격 증빙은 별도. 이후 배포 경로·도메인을 선택하고 DNS/HTTPS, canonical/OG/사이트맵, 검색 제외 해제를 진행한다. 병원 의료진 페이지에서 개인 사이트로 연결하는 작업은 별도이며 병원 사이트는 수정하지 않았다.
